...
$facturas = file_get_contents('https://mercadoapi.azurewebsites.net/apis/api_facturas.php');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($accion === 'editar' && $id && $id_cliente && $id_producto && $cantidad && $total) {
        ...
        $ch = curl_init('https://mercadoapi.azurewebsites.net/apis/api_facturas.php');
        ...
        $ch2 = curl_init('https://mercadoapi.azurewebsites.net/apis/api_productos.php');
